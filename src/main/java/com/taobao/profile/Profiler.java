...
public class Profiler {
        ...
        try {
            ...
            if (Manager.isNeedNanoTime()) {
                if (useTime > 500000) {
                    frameData[2] = useTime;
                    if (Manager.instance().isDebugMode()) {
                        System.out.println("endTime:" + methodId + Arrays.toString(frameData));
                    }
    ...
    public static void start4Mysql(String host, int port, String db, String sql) {
        ...
        System.out.println("start Mysql :" + threadId);
    ...
    public static void end4Mysql() {
        ...
        System.out.println("endTime:" + threadId + Arrays.toString(frameData));
